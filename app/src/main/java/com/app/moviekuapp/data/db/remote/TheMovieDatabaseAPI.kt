package com.app.moviekuapp.data.db.remote

import com.app.moviekuapp.data.model.entity.*
import com.app.moviekuapp.data.model.network.*
...
object TheMovieDatabaseAPI {
    ...
    interface MovieService {
        ...
        @GET("/$API_VERSION/movie/{id}/reviews")
        fun fetchReview(@Path("id") id: Int): Call<ReviewResponse>
